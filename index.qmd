...
invisible(getSymbols(c(gold_symbol, cad_symbol), 
                     from = "2024-12-01", 
                     to = "2025-12-31", 
                     src = "yahoo", 
                     auto.assign = TRUE))
...
p <- p %>% layout(
  title = list(text = "<b>Cost of food down 30% since start of year</b><br><sup>(Change in CPI for food indexed to Jan 2025 priced in gold)</sup>"),
  xaxis = list(
    title = "",
    showgrid = FALSE,
    tickformat = "%b %Y",
